    ...
    return(
        ...
        <div className="container mt-5   ">
            <div className="row text-center border">
                    <div className="col-3"> <h5>Equity Delevery</h5></div>
                    <div className="col-3"> <h5>Equity Intraday</h5> </div>
                    <div className="col-3"> <h5>F&O Future</h5></div>
                    <div className="col-3"> <h5 >F&O Options</h5></div>
            </div>
            ...
            <div className="row border text-muted p-4" >
             ...
             <div className="col-3 mt-3"> 
                <h3 className="fs-6"  >	Flat Rs. 20 per executed order</h3>
                <h3 className="fs-6 mt-5">0.15% of the intrinsic value on options that are bought and exercised </h3>
                <h3 className="fs-6 mt-5">NSE: 0.03553% (on premium)BSE: 0.0325% (on premium) </h3>
                <h3 className="fs-6 mt-5">	₹10 / crore </h3>
                <h3 className="fs-6 mt-5">0.003% or ₹300 / crore on buy side </h3>
             </div>
            </div>
